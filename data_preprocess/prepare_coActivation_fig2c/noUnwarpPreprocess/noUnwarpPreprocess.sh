...
echo python3 -u data_preprocess/prepare_coActivation_fig2c/noUnwarpPreprocess/noUnwarpPreprocess "${SLURM_ARRAY_TASK_ID}"
python3 -u data_preprocess/prepare_coActivation_fig2c/noUnwarpPreprocess/noUnwarpPreprocess "${SLURM_ARRAY_TASK_ID}"
echo "done"
