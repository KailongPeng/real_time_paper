...
if testMode:
    [sub, chosenMask, ses] = ['sub024', 'V1_FreeSurfer', 3]
    # [sub, chosenMask, ses, runNum, scanNum, testRun_training] = ['sub024', 'V1_FreeSurfer', 3, 1, 3, 1]
else:
    jobarrayDict = np.load(f"/gpfs/milgram/project/turk-browne/projects/rt-cloud/projects/rtSynth_rt/"
                           f"OrganizedScripts/ROI/autoAlign_ses1ses5/XYactivation/get_XYcoactivation_jobID.npy",
                           allow_pickle=True)
    ...
    # [sub, chosenMask, ses, runNum, scanNum, testRun_training]

print(f"sub={sub}, chosenMask={chosenMask}, ses={ses}")
