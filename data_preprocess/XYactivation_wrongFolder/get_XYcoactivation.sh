...
echo python3 -u /gpfs/milgram/project/turk-browne/projects/rt-cloud/projects/rtSynth_rt/OrganizedScripts/ROI/autoAlign_ses1ses5/XYactivation/get_XYcoactivation.py "${SLURM_ARRAY_TASK_ID}"
python3 -u /gpfs/milgram/project/turk-browne/projects/rt-cloud/projects/rtSynth_rt/OrganizedScripts/ROI/autoAlign_ses1ses5/XYactivation/get_XYcoactivation.py "${SLURM_ARRAY_TASK_ID}"
echo "done"
