...
echo python3 -u data_preprocess/prepareIntegrationScore/clf_training/clfTraining.py "${SLURM_ARRAY_TASK_ID}"
python3 -u data_preprocess/prepareIntegrationScore/clf_training/clfTraining.py "${SLURM_ARRAY_TASK_ID}"
echo "done"
